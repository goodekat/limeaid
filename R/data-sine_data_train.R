#' Sine Classifier Training Data
#'
#' A dataset that contains the training portion of the sine classifier data.
#'
...
#'
#' 500 observations were randomly selected from the generated data to be
